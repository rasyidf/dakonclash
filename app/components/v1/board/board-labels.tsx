...
export const BoardLabels = ({ size }: BoardLabelsProps) => {
  return (
    <>
      {/* Row labels (numbers) */}
      <div className="absolute left-0 top-4 bottom-4 flex flex-col justify-around text-xs sm:text-sm font-medium text-gray-600">
      ...
      <div className="absolute top-0 left-4 right-4 flex justify-around text-xs sm:text-sm font-medium text-gray-600">
        {Array.from({ length: size }, (_, i) => (
